      ...
      <div className="w-full py-5 absolute bg-custom-transparent shadow-2xl border border-primary border-opacity-50 rounded-md z-10 px-16 mobile:px-2 flex flex-col flex-nowrap justify-center">
        <div className=" flex flex-row flex-nowrap justify-center items-center mobile:flex-col">
          <Link href={"/"}>
            <h1
             ...
             laptop:text-lg text-secondary py-2 px-10 text-center flex-col justify-center "
            >
              Akdulum Kum Ocağı{" "}
              <span className="text-2xl mobile:text-lg text-white tracking-[7px] ">
                HAZIR BETON ÇİMENTO
              </span>
            </h1>
          </Link>
        ...
        <div className="flex flex-row flex-nowrap justify-between items-center shadow-lg py-2 mobile:flex-col mobile:gap-2 mobile:text-primary">
          ...
          <Link
            ...
            target="_blank"
            className="w-1/3 flex flex-row flex-nowrap justify-center items-center gap-3 laptop:gap-2 mobile:flex-row-reverse mobile:fixed-icon mobile:bottom-[50px] mobile:justify-end"
          >
          ...
          <Link
            ...
            className="w-1/3 flex flex-row flex-nowrap justify-end items-center gap-3 laptop:gap-2 mobile:fixed-icon mobile:bottom-[100px] mobile:justify-end mobile:flex-row-reverse"
          >
            <span
              href={"mailto:akdulumcimento@gmail.com"}
